...
import { ref } from 'vue'
import TabMonteCarlo from '@/views/pages/micro-economic-factors/TabMonteCarlo.vue'
import TabSimulationResult from '@/views/pages/micro-economic-factors/TabSimulationResult.vue'

const currentTab = ref('Monte Carlo Simulation')
const tabsData = ['Monte Carlo Simulation', 'Result']
  ...
  <VCard>
    ...
    <VCardText class="pt-0">
      <VWindow v-model="currentTab">
        <VWindowItem value="Monte Carlo Simulation">
          <TabMonteCarlo @change-tab="handleChangeTab" />
        </VWindowItem>
